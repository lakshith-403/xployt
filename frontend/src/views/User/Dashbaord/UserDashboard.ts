...
import { InvitationsTable } from './InvitationsTable'; // Import InvitationsTable
...
class DashboardView extends View {
  ...
  private renderInvitationsTable(q: Quark): void {
    ...
    const invitationsTable = new InvitationsTable(this.invitations);
    invitationsTable.render(collapsible.getContent(), this.acceptInvitation.bind(this));
  }
  ...
  private renderEarnings(q: Quark): void {
    $(q, 'div', 'earnings-section', {}, (q) => {
      $(q, 'div', 'earning-box', {}, (q) => {
        ...
        $(q, 'h3', '', {}, '$548.00'); // Use text content directly
      });
      $(q, 'div', 'earning-box', {}, (q) => {
        $(q, 'span', 'pending-earnings', {}, 'Pending earnings:');
        $(q, 'h3', '', {}, '$45.00'); // Use text content directly
      });
      $(q, 'div', 'earning-box', {}, (q) => {
        $(q, 'span', 'total-project-earnings', {}, 'Total project earnings:');
        $(q, 'h3', '', {}, '$50.00'); // Use text content directly
      });
    });
  }
